...
abstract class PromoCheckoutCart extends StoreCheckoutCart
{
     ...
     *                       discount
     *
     * @return float the promotion discount total of this cart's contents
     */
    public function getPromotionDiscount($entries = null)
    {
        ...
        } elseif ($this->promotion instanceof PromoPromotion) {
        ...
        usort($entries, [$this, 'compareEntriesByPrice']);

        $discount = 0;
        $discount_quantity = 0;
        $discountable_item_total = 0;
        $discountable_entries = [];
        ...
        if ($promotion->isFixedDiscount()) {
            ...
            foreach ($discountable_entries as $entry) {
                ...
                $entry->promotion_discount = SwatNumber::roundToEven(
                    $amount * $promotion->discount_percentage,
                    2
                );
     ...
     *
     * @return float the discountable total of this cart's contents
     */
